  ...
  return (
    ...
    >
      <div className="backdrop-blur-sm p-8 rounded-lg shadow-lg">
        <h2 className="text-4xl font-bold mb-8 text-center text-primary">Add A Lesson</h2>
        ...
        >
          ...
          <div className="lg:col-span-2">
            ...
            <textarea
              ...
              {...register("description", { required: "Lesson description is required" })}
          ...
          <div>
            ...
            {errors.emotionalTone && (
              <p className="text-red-500 mt-1">{errors.emotionalTone.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            <select
              ...
              title={
                !isPremiumUser ? "Upgrade to Premium to create paid lessons" : undefined
              }
              className={`select select-bordered w-full ${
