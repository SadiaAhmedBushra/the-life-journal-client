    ...
    >
      <div className="flex flex-col gap-6 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full">
          <div className="backdrop-blur-sm p-6 lg:p-8 rounded-lg shadow-lg bg-white/60 lg:col-span-4 flex flex-col items-center justify-between gap-4">
          ...
          <div className="backdrop-blur-sm rounded-lg shadow-lg bg-white/60 lg:col-span-8 p-6 lg:py-8">
            <div className="flex flex-col gap-10 w-full">
              <div className="flex flex-col lg:flex-row justify-around items-start w-full">
                <div className="flex flex-col justify-center items-start gap-6 w-full lg:w-auto">
              ...
              <Link to="/dashboard/update-my-profile" className=" w-full lg:w-auto mx-auto">
