...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-main ">
      ...
      <div className="navbar-center hidden lg:flex rounded-full border font-semibold border-indigo-300" style={{ color: "var(--text-primary)" }}
>
        <ul className="menu menu-horizontal px-1" style={{ color: "var(--text-primary)" }}
>{links}</ul>
      </div>
